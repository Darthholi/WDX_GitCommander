...
#ifdef _BCB    //C++Builder way
//basically did it c++ compilable
//added explicit pointer conversions (something*)
//deleted bad habit of naming variables to the struct name: push_spec* push_spec;
#define _WIN32
...
//Generic Hashing
#define WIN32_SHA1
//#define GIT_COMMON_CRYPTO
//delete stdint from git2 include
//#define PrID64 "%I64d" //for windows
