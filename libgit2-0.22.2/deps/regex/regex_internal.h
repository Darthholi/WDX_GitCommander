...
reg_errcode_t re_string_realloc_buffers (re_string_t *pstr,
     ...
     internal_function;
# ifdef RE_ENABLE_I18N
void build_wcs_buffer (re_string_t *pstr) internal_function;
...
reg_errcode_t internal_function re_string_allocate (re_string_t *pstr, const char *str, int len, int init_len,
		    RE_TRANSLATE_TYPE trans, int icase, const re_dfa_t *dfa);
reg_errcode_t internal_function re_string_reconstruct (re_string_t *pstr, int idx, int eflags);
reg_errcode_t internal_function re_node_set_init_union (re_node_set *dest, const re_node_set *src1,			const re_node_set *src2);
re_dfastate_t * internal_function re_acquire_state (reg_errcode_t *err, const re_dfa_t *dfa,		  const re_node_set *nodes);
reg_errcode_t internal_function re_node_set_add_intersect (re_node_set *dest, const re_node_set *src1,			   const re_node_set *src2);
void internal_function re_node_set_remove_at (re_node_set *set, int idx);
