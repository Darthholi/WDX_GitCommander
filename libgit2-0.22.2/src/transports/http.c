	...
	void *data)
{
	...
	*out = NULL;
	...
	git_vector_foreach(&t->auth_contexts, i, c, git_http_auth_context *) {
	...
	int *allowed_types)
{
	...
	git_vector_foreach(www_authenticate, i, challenge, char*) {
...
static int http_close(git_smart_subtransport *subtransport)
{
	...
	git_vector_foreach(&t->auth_contexts, i, context, git_http_auth_context *) {
		if (context->free)
