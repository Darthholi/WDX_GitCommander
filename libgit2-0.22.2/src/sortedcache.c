...
static void sortedcache_clear(git_sortedcache *sc)
{
	...
	if (sc->free_item) {
		...
		git_vector_foreach(&sc->items, i, item, void*) {
...
{
	git_sortedcache *sc = (git_sortedcache *) payload;
	...
	void *payload)
{
	...
	git_vector_foreach(&src->items, i, src_item, void*) {
...
{
	const struct sortedcache_magic_key *magic = (sortedcache_magic_key *) key;
...
int git_sortedcache_remove(git_sortedcache *sc, size_t pos)
{
	...
	if ((item = (char*) git_vector_get(&sc->items, pos)) == NULL) {
