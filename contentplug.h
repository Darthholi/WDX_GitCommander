...
#ifdef __cplusplus
#define PLUGFUNC extern "C" __declspec(dllexport)
#else
#define PLUGFUNC __declspec(dllexport)
#endif
...
#define PLUGFUNC extern "C" __declspec(dllexport)
#else
#define PLUGFUNC __declspec(dllimport)
#endif
...
PLUGFUNC int __stdcall ContentGetValue(char* FileName,int FieldIndex,int UnitIndex,void* FieldValue,int maxlen,int flags);
PLUGFUNC int __stdcall ContentGetValueW(WCHAR* FileName,int FieldIndex,int UnitIndex,void* FieldValue,int maxlen,int flags);
...
PLUGFUNC void __stdcall ContentStopGetValue(char* FileName);
PLUGFUNC void __stdcall ContentStopGetValueW(WCHAR* FileName);
...
PLUGFUNC int __stdcall ContentSetValue(char* FileName,int FieldIndex,int UnitIndex,int FieldType,void* FieldValue,int flags);
PLUGFUNC int __stdcall ContentSetValueW(WCHAR* FileName,int FieldIndex,int UnitIndex,int FieldType,void* FieldValue,int flags);

PLUGFUNC int __stdcall ContentEditValue(HWND ParentWin,int FieldIndex,int UnitIndex,int FieldType,
                void* FieldValue,int maxlen,int flags,char* langidentifier);
PLUGFUNC void __stdcall ContentSendStateInformation(int state,char* path);
PLUGFUNC void __stdcall ContentSendStateInformationW(int state,WCHAR* path);

PLUGFUNC int __stdcall ContentCompareFiles(PROGRESSCALLBACKPROC progresscallback,int compareindex,char* filename1,char* filename2,FileDetailsStruct* filedetails);
PLUGFUNC int __stdcall ContentCompareFilesW(PROGRESSCALLBACKPROC progresscallback,int compareindex,WCHAR* filename1,WCHAR* filename2,FileDetailsStruct* filedetails);
